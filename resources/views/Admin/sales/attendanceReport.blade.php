                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">Theater</th>
                                <th class="min-w-50px">Musium</th>
                                <th class="min-w-50px">Kimit</th>
                                <th class="min-w-50px">Cinma</th>
                            </tr>
                            </thead>
...
@section('ajaxCalls')
    ...
    <script>
        ...
        var columns = [
            ...
            {data: 'Theater', name: 'Theater'},
            {data: 'Musium', name: 'Musium'},
            {data: 'Kimit', name: 'Kimit'},
            {data: 'Cinma', name: 'Cinma'},
        ]
