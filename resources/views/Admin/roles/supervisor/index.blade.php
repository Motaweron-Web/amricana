        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="">
                        <a href="{{route('roles_supervisors.create')}}" class="btn btn-secondary btn-icon text-white addBtn">
									<span>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('roles_supervisors.index')}}', columns);
        deleteScript('{{route('roles_supervisors.delete')}}');
    </script>
@endsection
