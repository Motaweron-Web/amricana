                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">group</th>
                                <th class="min-w-50px">activity</th>
                                <th class="min-w-50px">Time of group</th>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('routes.index')}}', columns);
        deleteScript('{{route('routes.delete')}}');

        // Get Edit View
        $(document).on('click', '.editBtn', function () {
            var id = $(this).data('id')
            var url = "{{route('routes.edit',':id')}}";
        ...
        $(document).on('click', '.addBtn', function () {
            ...
            $('#editOrCreate').modal('show')
            setTimeout(function () {
                $('#modalContent').load('{{route('routes.create')}}')
            }, 250)
        });
