        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-lg-0 ">
                <div class="card card-plain">
                    ...
                    <div class="card-body">
                        <form action="{{route('activity.login')}}" method="post" id="LoginForm"
                            ...
                            <div class="text-center ">
                                <button type="submit" id="loginButton"
                                        class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"><i id="lockId"
                                                                                                         class="fa fa-lock"
            ...
            <div
                class="col-6 d-md-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                <div
                    class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
                    <img src="{{asset('assets/sales/img/pattern-lines.svg')}}" alt="pattern-lines"
                         class="position-absolute opacity-4 start-0">
                    <div class="position-relative">
                        <img class="max-width-500 w-100 position-relative z-index-2"
                             src="{{asset('assets/sales/img/rocket-white.png')}}" alt="chat-img">
                    </div>
