...
//            if($top_up_hours == 1 &&  $ticket->hours_count == 1){
//
//                $ticket->grand_total =  $model->type['2_hours'];
//                $ticket->paid_amount = $model->type['2_hours'];
//                $ticket->total_price = $model->type['2_hours'];
//
//            } elseif($top_up_hours == 2 &&  $ticket->hours_count == 1){
//
//                $ticket->grand_total =  $model->type['3_hours'];
//                $ticket->paid_amount = $model->type['3_hours'];
//                $ticket->total_price = $model->type['3_hours'];
//
//
//            } elseif($top_up_hours == 3 &&  $ticket->hours_count == 1){
//
//                $ticket->grand_total =  $model->type['4_hours'];
//                $ticket->paid_amount = $model->type['4_hours'];
//                $ticket->total_price = $model->type['4_hours'];
//
//
//            } elseif($top_up_hours == 4 &&  $ticket->hours_count == 1){
//
//                $ticket->grand_total =  $model->type['5_hours'];
//                $ticket->paid_amount = $model->type['5_hours'];
//                $ticket->total_price = $model->type['5_hours'];
//
//            }//step number 1
//
//            //step number 2
//            if($top_up_hours == 1 &&  $ticket->hours_count == 2){
//
//                $ticket->grand_total =  $model->type['3_hours'];
//                $ticket->paid_amount = $model->type['3_hours'];
//                $ticket->total_price = $model->type['3_hours'];
//
//
//            } elseif($top_up_hours == 2 &&  $ticket->hours_count == 2){
//
//                $ticket->grand_total +=  ($price * 1.14);
//                $ticket->paid_amount += ($price * 1.14);
//                $ticket->total_price += ($price * 1.14);
//
//
//            } elseif($top_up_hours == 3 &&  $ticket->hours_count == 2){
//
//                $ticket->grand_total =  $model->type['5_hours'];
//                $ticket->paid_amount = $model->type['5_hours'];
//                $ticket->total_price = $model->type['5_hours'];
//
//
//            } elseif($top_up_hours == 4 &&  $ticket->hours_count == 2){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['1_hours'];
//
//
//
//            }elseif($top_up_hours == 5 &&  $ticket->hours_count == 2){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['2_hours'];
//
//            }
//
//
//            //step number 3
//            if($top_up_hours == 1 &&  $ticket->hours_count == 3){
//
//                $ticket->grand_total =  $model->type['4_hours'];
//                $ticket->paid_amount = $model->type['4_hours'];
//                $ticket->total_price = $model->type['4_hours'];
//
//
//            } elseif($top_up_hours == 2 &&  $ticket->hours_count == 3){
//
//                $ticket->grand_total =  $model->type['5_hours'];
//                $ticket->paid_amount = $model->type['5_hours'];
//                $ticket->total_price = $model->type['5_hours'];
//
//
//            } elseif($top_up_hours == 3 &&  $ticket->hours_count == 3){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['1_hours'];
//
//
//            } elseif($top_up_hours == 4 &&  $ticket->hours_count == 3){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['2_hours'];
...
//
//
//            }elseif($top_up_hours == 5 &&  $ticket->hours_count == 3){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['3_hours'];
//
//            }
//
//
//
//            //step number 4
//            if($top_up_hours == 1 &&  $ticket->hours_count ==  4 ){
//
//                $ticket->grand_total =  $model->type['5_hours'];
//                $ticket->paid_amount = $model->type['5_hours'];
//                $ticket->total_price = $model->type['5_hours'];
//
//
//            } elseif($top_up_hours == 2 &&  $ticket->hours_count == 4  ){
//
//                $ticket->grand_total =   $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['1_hours'];
//
//
//            } elseif($top_up_hours == 3 &&  $ticket->hours_count ==  4 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['2_hours'];
//
//
//            } elseif($top_up_hours == 4 &&  $ticket->hours_count ==  4 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['3_hours'];
...
//
//
//            }elseif($top_up_hours == 5 &&  $ticket->hours_count == 4 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['4_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['4_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['4_hours'];
//
//            }
//
//
//            //step number 5
//            if($top_up_hours == 1 &&  $ticket->hours_count ==  5 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['1_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['1_hours'];
//
//
//            } elseif($top_up_hours == 2 &&  $ticket->hours_count == 5  ){
//
//                $ticket->grand_total =   $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['2_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['2_hours'];
//
//
//            } elseif($top_up_hours == 3 &&  $ticket->hours_count ==  5 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['3_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['3_hours'];
//
//
//            } elseif($top_up_hours == 4 &&  $ticket->hours_count ==   5){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['4_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['4_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['4_hours'];
...
//
//
//            }elseif($top_up_hours == 5 &&  $ticket->hours_count == 5 ){
//
//                $ticket->grand_total =  $model->type['5_hours'] + $model->type['5_hours'];
//                $ticket->paid_amount = $model->type['5_hours'] + $model->type['5_hours'];
//                $ticket->total_price = $model->type['5_hours'] + $model->type['5_hours'];
//
//            }
...
//                'cashier_id' => auth()->user()->id,
//                'day' => Carbon::now()->format('Y-m-d'),
//                'amount' =>  $model->type['5_hours'] -  $model->type['1_hours'],
//                'payment_method' => 'cash',
//
//            ]);
//            $price_of_one = $model->type['5_hours'] -  $model->type['1_hours'];
//            $ticket->grand_total =  ( $ticket->grand_total -   $price_of_one );
//            $ticket->paid_amount = ( $ticket->paid_amount -   $price_of_one );
//            $ticket->total_price = ( $ticket->total_price -   $price_of_one );
//            $ticket->ticket_price = $ticket->grand_total == 0 ? 0 : ($ticket->grand_total)  / 1.14;
...
//        if($request->top_down_hours == 2 && $ticket->hours_count == 2) {
//
//
//            $price_of_one =  ($ticket->grand_total - $model->price);
//            $ticket->grand_total = $price_of_one;
//            $ticket->paid_amount = $price_of_one;
//            $ticket->total_price = $price_of_one;
//            $ticket->ticket_price = ($ticket->ticket_price - ($model->price / 1.14));
//            $ticket->vat = ($ticket->vat) - ($model->price - ($model->price / 1.14));
//            $model->price = 0;
//            $total_of_down_price = $price_of_one;
//
//
