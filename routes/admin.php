...
Route::group(['prefix'=>'admin','middleware'=>['auth:admin','CheckAdmin'],'namespace'=>'Admin'],function (){
    ...
    Route::resource('places','VisitorPlaceController')->except('destroy','update','show');//add places for visitors
    Route::post('places/delete','VisitorPlaceController@delete')->name('places.delete');//delete
    Route::put('places/updatePlace','VisitorPlaceController@updatePlace')->name('places.updatePlace');//update
